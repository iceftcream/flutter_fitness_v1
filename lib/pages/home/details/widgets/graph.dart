...
class _GraphAreaState extends State<GraphArea>
  ...
  void initState() {
    ...
    _animationController = AnimationController(
        vsync: this, duration: Duration(seconds: 2)); //fulfill late
...
class GraphPainter extends CustomPainter {
  ...
  GraphPainter(Animation<double> animation, {required this.data})
      : _size = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(
            parent: animation,
            curve:
                Interval(0.0, 0.75, curve: Curves.easeInOutCubicEmphasized))),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint shadowPaint = Paint()
      ...
      ..style = PaintingStyle.stroke
      ..maskFilter =
          ui.MaskFilter.blur(ui.BlurStyle.solid, 3) //gives the white shadow
      ..strokeWidth = 3.0;
